...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CustomRegistration'
        db.create_table(u'register_customregistration', (
        ...
        db.send_create_signal(u'register', ['CustomRegistration'])


    def backwards(self, orm):
        # Deleting model 'CustomRegistration'
        db.delete_table(u'register_customregistration')
    ...
    models = {
        ...
        u'register.customregistration': {
            'Meta': {'object_name': 'CustomRegistration', '_ormbases': [u'registration.RegistrationProfile']},
