...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'register_post', 'created',
        ...
        db.add_column(u'register_profile', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 7, 11, 0, 0), blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'register_post', 'created')

        # Deleting field 'Profile.last_modified'
        db.delete_column(u'register_profile', 'last_modified')
