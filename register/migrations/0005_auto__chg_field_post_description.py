...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'register_post', 'description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Post.description'
        db.alter_column(u'register_post', 'description', self.gf('django.db.models.fields.TextField')(default=2))
