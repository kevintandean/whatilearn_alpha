"""
Django settings for whatilearn_alpha project.
...
SECRET_KEY = '2br#)k@khz%s+p-qei+!ia31ak=^u0t-^1x64agrb)4lqh1@*+'
...
ROOT_URLCONF = 'whatilearn_alpha.urls'

WSGI_APPLICATION = 'whatilearn_alpha.wsgi.application'
